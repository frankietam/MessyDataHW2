...
```{r}
vote_pred=rep("barack obama", 10000)
...
### iv)
```{r}
vote_pred_t70=rep("john mcCain", 10000)
...
Accuracy goes down from 0.8577 to 0.8293. Precision for predicting vote for obama goes down from 0.895 to 0.771 while recall goes up from 0.861 to 0.917. On the other hand, precision for predicting vote for mcCain goes up from 0.808 to 0.907 and recall goes down from 0.852 to 0.748.
